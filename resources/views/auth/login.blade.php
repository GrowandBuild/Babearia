<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <!-- Email, Username ou Telefone -->
        <div>
            <label for="login" class="block text-sm font-medium text-gray-700 mb-1">Email, Usuário ou Telefone</label>
            <div class="relative">
        ...
        <!-- Botão de Login -->
        <button type="submit" class="w-full btn-primary text-center justify-center flex items-center gap-2 py-3 text-base" style="background: var(--brand-btn-primary-bg); color: var(--brand-btn-primary-text);">
