...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Editar Banner</h1>
        <p class="mt-2 text-gray-600">Atualize as imagens e informações do banner</p>
    </div>

    <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-8">
        @csrf
        @method('PUT')
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="ordem" value="{{ old('ordem', $banner->ordem) }}" min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="0">
                    @error('ordem')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            ...
            <div class="mt-6">
                ...
                <textarea name="descricao" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="Descreva o banner...">{{ old('descricao', $banner->descricao) }}</textarea>
                @error('descricao')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-6">
                ...
                <input type="url" name="link_destino" value="{{ old('link_destino', $banner->link_destino) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div class="mb-8">
            ...
            @if ($banner->banner_desktop)
                <div class="mb-6">
                    ...
                    <div class="relative bg-gray-100 rounded-lg overflow-hidden border-2 border-gray-200" style="max-width: 600px; aspect-ratio: 16/4;">
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition" id="dropZoneDesktop">
                ...
                <label for="banner_desktop" class="cursor-pointer">
                    ...
                    <p class="text-sm text-gray-500 mt-1">PNG, JPG, GIF, WEBP (máx. 5MB) - Deixe vazio para manter a imagem atual</p>
                </label>
        ...
        <div class="mb-8">
            <label class="flex items-center">
                ...
                <input type="checkbox" name="ativo" value="1" {{ old('ativo', $banner->ativo) ? 'checked' : '' }}
                       class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500">
                <span class="ml-2 text-sm font-medium text-gray-700">Banner Ativo</span>
            </label>
        </div>
